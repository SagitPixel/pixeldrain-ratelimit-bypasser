...
async function handleRequest(request) {
  ...
  // 核心修改 1：直接请求 pixeldrain.dev 的 API
  const targetUrl = `https://pixeldrain.dev/api/file/${fileId}?download`;

  const modifiedRequest = new Request(targetUrl, {
    method: 'GET',
    headers: {
      'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
      // 核心修改 2：Referer 必须同步改为 .dev
...
<body class="bg-gradient-to-br from-slate-900 to-indigo-900 text-white min-h-screen flex flex-col font-mono">
    <div class="container mx-auto px-4 py-8 flex-grow">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex input-group">
                        <input 
                            type="text" 
                            id="inputUrl" 
                            placeholder="https://pixeldrain.dev/u/e75isJ7y"
        ...
        <div class="max-w-2xl mx-auto mt-8 bg-white/10 backdrop-blur-lg rounded-xl shadow-2xl p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4 feature-grid">
                ...
                <div class="bg-indigo-600/20 p-4 rounded-lg">
                    <h3 class="font-bold mb-2">⚡ Clean IP Addresses</h3>
                    <p class="text-sm">Powered by Deno Deploy's edge infrastructure</p>
                </div>
                <div class="bg-indigo-600/20 p-4 rounded-lg">
    ...
    function convertUrl() {
        ...
        // 核心修改 3：使用正则同时兼容 .com 和 .dev
        const match = input.match(/pixeldrain\.(?:com|dev)\/u\/([a-zA-Z0-9_-]+)/i);
        ...
        if (match && match[1]) {
            ...
            alert("无法识别此链接，请确保输入正确的 pixeldrain.com 或 pixeldrain.dev 链接");
        }
    }
    ...
    function copyUrl() {
        ...
        alert("Copied the text: " + outputUrl.value);
    }
